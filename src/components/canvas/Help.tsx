	...
	return (
		<div>
			...
			>
				...
				<DialogContentText>
					{"At the start of the game, you choose one word/phrase from two options. You then have to draw "
					+ "that word/phrase and submit it within the given time frame."}
				</DialogContentText>
				<DialogContentText>
					...
					+ "sent to you. You then have to look at their drawing and guess what their word/phrase was and submit "
					+ "that guess before the round timer ends."}
				</DialogContentText>
				<DialogContentText>
					{"Same as the drawings being sent, your guess of the word/phrase will now be sent to the player next in "
					+ "the list and you will receive the guess from the player previous in the list to you. This has now "
					+ "done a cycle because you're now back with a word/phrase to draw. So as you did at the beginning, draw "
					+ "that word/phrase given to you and submit it."}
				</DialogContentText>
				<DialogContentText>
